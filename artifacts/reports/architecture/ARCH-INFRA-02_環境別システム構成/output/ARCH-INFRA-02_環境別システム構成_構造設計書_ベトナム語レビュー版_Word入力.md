...
- Cấu hình nội bộ của MVE số 1 và MVE số 2.
- Quy trình deploy và thao tác chuyển đổi MVE active node.

## Tài liệu liên quan

| No. | Mã tài liệu | Tài liệu hoặc nguồn liên quan | Quan hệ với tài liệu này |
|---|---|---|---|
| ① | ARCH-INFRA-01 | Tài liệu thiết kế cấu trúc hạ tầng | Tài liệu kiến trúc trước đó, sở hữu cấu trúc AWS và domain DEV/PRD |
| ② | ARCH-INFRA-01 | Sơ đồ cấu trúc hạ tầng Draw.io | Sơ đồ AWS và domain do dự án lập trước đó |
| ③ | - | Cấu hình runtime DEV/STG/PRD | Nguồn xác minh ECS service, database và MVE endpoint hiện tại |

## Quan hệ môi trường và MVE
...
![diagram](./diagrams/ARCH-INFRA-02_環境別システム構成_構造設計書_ベトナム語レビュー版_Word入力-1.png)

## Giải thích cấu hình hệ thống
...
## Cấu hình chi tiết theo môi trường
...
## Sơ đồ luồng kết nối MVE

### 8.1 Luồng cấu hình và sử dụng MVE

![diagram](./diagrams/ARCH-INFRA-02_環境別システム構成_構造設計書_ベトナム語レビュー版_Word入力-2.png)

## Giải thích luồng kết nối MVE
...
5. Không xác định MVE số 1 hoặc MVE số 2 chỉ từ hostname hay IP. Tài liệu hiện có chưa định nghĩa mapping vật lý giữa hai tên máy này.
...
|---|---|---|
| SRC-ENV-001 | ARCH-INFRA-01 và sơ đồ Draw.io | Cấu trúc AWS, domain, ECS và thiết kế DEV/PRD trước đó |
