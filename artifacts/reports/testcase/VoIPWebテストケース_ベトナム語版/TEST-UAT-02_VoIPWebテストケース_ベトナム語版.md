...
## テストケース {sheet=WEB_UAT_TC}
### AUTH-01 Quản trị viên hệ thống đăng nhập thành công (IP whitelist)
ID: AUTH-01
...
実行手順:
① Round 1 (DEV): truy cập https://dev.apl.purattocall.com/admin/login
   Round 2 (PRD): truy cập https://apl.purattocall.com/admin/login
...
### AUTH-02 Đăng nhập thất bại - sai mật khẩu
ID: AUTH-02
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-03 Đăng nhập thất bại - IP ngoài whitelist (quản trị viên hệ thống/Okada Denki)
ID: AUTH-03
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-04 Đổi mật khẩu thành công
ID: AUTH-04
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-05 Đổi mật khẩu thất bại - mật khẩu mới không đáp ứng điều kiện
ID: AUTH-05
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-06 Khôi phục mật khẩu bằng OTP qua email
ID: AUTH-06
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-07 Nhập sai OTP 5 lần liên tiếp khi đặt lại mật khẩu
ID: AUTH-07
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-08 Thực hiện lại đặt lại mật khẩu trong thời gian khóa sau khi nhập sai OTP 5 lần liên tiếp
ID: AUTH-08
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### AUTH-09 Đăng nhập thất bại 5 lần liên tiếp
ID: AUTH-09
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Đăng nhập và bảo mật
...
### SA-T01 Tạo tenant mới - tenant sử dụng điện thoại cố định
ID: SA-T01
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T02 Tạo tenant mới - không sử dụng điện thoại cố định
ID: SA-T02
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T03 Tạo tenant thất bại - mã tenant ngoài phạm vi (điện thoại cố định)
ID: SA-T03
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T04 Tạo tenant thất bại - thiếu quản trị viên tenant
ID: SA-T04
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T05 Tìm kiếm tenant theo tên tenant
ID: SA-T05
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T06 Lọc tenant theo trạng thái "登録待ち"
ID: SA-T06
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T07 Kiểm tra chi tiết thông tin tenant
ID: SA-T07
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T08 Hiển thị danh sách người dùng trong tenant (popup xem)
ID: SA-T08
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T09 Kiểm tra lịch sử số lượng người dùng trong tháng hiện tại
ID: SA-T09
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T10 Chỉnh sửa thông tin hợp đồng tenant
ID: SA-T10
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T11 Kiểm tra lịch sử chỉnh sửa tenant
ID: SA-T11
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T12 Dừng tenant đang ở trạng thái "利用中"
ID: SA-T12
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T13 Kiểm tra nút "停止する" không hiển thị khi tenant ở trạng thái "停止"
ID: SA-T13
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T14 Kích hoạt lại tenant ở trạng thái "停止"
ID: SA-T14
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T16 Gửi thông tin đăng nhập cho quản trị viên tenant
ID: SA-T16
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T17 Không gửi lại cho quản trị viên tenant đã nhận email
ID: SA-T17
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T18 Xuất danh sách tenant ra CSV
ID: SA-T18
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T19 Khởi động batch thủ công để đồng bộ trạng thái người dùng
ID: SA-T19
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T20 Kiểm tra người dùng "削除済み" bằng batch tự động
ID: SA-T20
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-T21 Tải xuống template CSV import người dùng
ID: SA-T21
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Quản lý tenant
...
### SA-I01 Kiểm tra chuyển đến màn hình import người dùng bằng role quản trị viên hệ thống
ID: SA-I01
画面/機能カテゴリ: Quản trị viên hệ thống
...
### SA-I02 Kiểm tra chuyển đến màn hình import người dùng bằng role quản trị viên hệ thống
ID: SA-I02
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
中項目: Kiểm tra chuyển đến màn hình import người dùng bằng role quản trị viên hệ thống
...
### SA-I03 Upload CSV hợp lệ - tạo thành công tất cả người dùng
ID: SA-I03
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I04 Upload thất bại - file không phải CSV
ID: SA-I04
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I05 Upload thất bại - header CSV khác template
ID: SA-I05
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I06 Upload thất bại - file CSV rỗng
ID: SA-I06
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I07 Upload thất bại - có dữ liệu lỗi (trùng email)
ID: SA-I07
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I08 Upload thất bại - trùng số SIP trong cùng tenant
ID: SA-I08
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I09 Upload lại sau khi sửa file lỗi
ID: SA-I09
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I10 Upload thất bại - file vượt quá 50MB
ID: SA-I10
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I11 Upload thất bại - số SIP không hợp lệ
ID: SA-I11
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
...
### SA-I12 Upload thất bại - số SIP không hợp lệ
ID: SA-I12
画面/機能カテゴリ: Quản trị viên hệ thống
大項目: Import người dùng
中項目: Upload thất bại - số SIP không hợp lệ
...
### AUTH-01 Quản trị viên tenant đăng nhập - nhận và nhập OTP thành công
ID: AUTH-01
...
### AUTH-02 OTP hết hạn - gửi lại OTP thành công
ID: AUTH-02
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
...
### AUTH-03 Đổi mật khẩu thành công
ID: AUTH-03
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
中項目: Đổi mật khẩu thành công
...
### AUTH-04 Đổi mật khẩu thất bại - mật khẩu mới không đáp ứng điều kiện
ID: AUTH-04
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
中項目: Đổi mật khẩu thất bại - mật khẩu mới không đáp ứng điều kiện
...
### AUTH-05 Khôi phục mật khẩu bằng OTP qua email
ID: AUTH-05
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
中項目: Khôi phục mật khẩu bằng OTP qua email
...
### AUTH-06 Đăng nhập thất bại 5 lần liên tiếp
ID: AUTH-06
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
中項目: Đăng nhập thất bại 5 lần liên tiếp
...
### AUTH-10 Nhập sai mã OTP 5 lần liên tiếp
ID: AUTH-10
画面/機能カテゴリ: Quản trị viên tenant
大項目: Đăng nhập và bảo mật
...
### TA-U01 Hiển thị danh sách người dùng sau khi đăng nhập
ID: TA-U01
画面/機能カテゴリ: Quản trị viên tenant
...
### TA-U02 Tìm kiếm người dùng theo email
ID: TA-U02
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U03 Tìm kiếm người dùng theo họ tên
ID: TA-U03
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U04 Lọc người dùng theo trạng thái "利用中"
ID: TA-U04
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U05 Thêm người dùng mới thành công (MVE API thành công)
ID: TA-U05
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U06 Thêm người dùng thất bại - email đã tồn tại trong hệ thống
ID: TA-U06
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U07 Thêm người dùng thất bại - số SIP đã được sử dụng trong tenant
ID: TA-U07
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U08 Thêm người dùng thất bại - thiếu trường bắt buộc
ID: TA-U08
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U09 Kiểm tra phạm vi SIP theo loại tenant
ID: TA-U09
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U10 Kiểm tra chi tiết thông tin người dùng
ID: TA-U10
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U11 Kiểm tra nút "編集" và "削除" với người dùng trạng thái "削除済み"
ID: TA-U11
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U12 Chỉnh sửa thông tin người dùng - cập nhật họ tên
ID: TA-U12
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U13 Gửi email kích hoạt cho người dùng "登録済み"
ID: TA-U13
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U14 Gửi lại email kích hoạt cho người dùng "アクティブ待ち"
ID: TA-U14
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U15 Không thể gửi email kích hoạt cho người dùng ngoài trạng thái "登録済み" và "アクティブ待ち"
ID: TA-U15
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U16 Quay lại danh sách người dùng bằng nút "戻る"
ID: TA-U16
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-U17 Tải xuống template CSV từ màn hình danh sách người dùng
ID: TA-U17
画面/機能カテゴリ: Quản trị viên tenant
大項目: Quản lý người dùng
...
### TA-I01 Upload CSV hợp lệ - tất cả người dùng được tạo
ID: TA-I01
画面/機能カテゴリ: Quản trị viên tenant
...
### TA-I02 Upload thất bại - chưa chọn file
ID: TA-I02
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I03 Upload thất bại - chỉ có header, không có dữ liệu
ID: TA-I03
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I04 Upload thất bại - chỉ có dữ liệu, không có header
ID: TA-I04
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I05 Upload thất bại - họ chứa ký tự đặc biệt không được phép
ID: TA-I05
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I06 Upload thất bại - họ kana chứa ký tự không phải katakana
ID: TA-I06
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I07 Upload thất bại - số SIP không phải 4 chữ số (tenant điện thoại cố định)
ID: TA-I07
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I08 Upload thất bại - số SIP không hợp lệ
ID: TA-I08
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
中項目: Upload thất bại - số SIP không hợp lệ
...
### TA-I09 Upload thất bại - số SIP không hợp lệ
ID: TA-I09
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
中項目: Upload thất bại - số SIP không hợp lệ
...
### TA-I10 Upload thất bại - email bị trùng trong cùng file CSV
ID: TA-I10
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I11 Kiểm tra import bị vô hiệu hóa trong thời gian bảo trì
ID: TA-I11
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-I12 Import hoạt động lại bình thường sau khi kết thúc bảo trì
ID: TA-I12
画面/機能カテゴリ: Quản trị viên tenant
大項目: Import hàng loạt người dùng
...
### TA-D01 Xóa người dùng thành công
ID: TA-D01
画面/機能カテゴリ: Quản trị viên tenant
大項目: Xóa người dùng
...
### TA-D02 Kiểm tra người dùng "削除済み" vẫn tiếp tục hiển thị trong danh sách
ID: TA-D02
画面/機能カテゴリ: Quản trị viên tenant
大項目: Xóa người dùng
...
### TA-D03 Tài khoản SIP được xóa khỏi MVE sau khi Okada Denki thực hiện bảo trì
ID: TA-D03
画面/機能カテゴリ: Quản trị viên tenant
大項目: Xóa người dùng
...
### AUTH-02 Quản trị viên Okada Denki đăng nhập thành công (IP whitelist)
ID: AUTH-02
...
### AUTH-05 Đăng nhập thất bại - IP ngoài whitelist (quản trị viên hệ thống/Okada Denki)
ID: AUTH-05
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Đăng nhập và bảo mật
中項目: Đăng nhập thất bại - IP ngoài whitelist (quản trị viên hệ thống/Okada Denki)
...
### OD-T01 Tìm kiếm tenant theo tenant ID
ID: OD-T01
画面/機能カテゴリ: Quản trị viên Okada Denki
...
### OD-T02 Tìm kiếm tenant theo tên nhóm IP
ID: OD-T02
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Quản lý tên nhóm IP của tenant
...
### OD-T03 Kiểm tra tenant "登録待ち" được ưu tiên hiển thị đầu danh sách
ID: OD-T03
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Quản lý tên nhóm IP của tenant
...
### OD-T04 Xác nhận hoàn tất tạo tên nhóm IP cho tenant "登録待ち"
ID: OD-T04
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Quản lý tên nhóm IP của tenant
...
### OD-T05 Xác nhận IPGroup - nút không khả dụng với tenant "利用中"
ID: OD-T05
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Quản lý tên nhóm IP của tenant
...
### OD-T06 Xác nhận hàng loạt IPGroup của nhiều tenant
ID: OD-T06
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Quản lý tên nhóm IP của tenant
...
### OD-M01 Hủy bảo trì khi nhấn "キャンセル" trên popup
ID: OD-M01
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Bảo trì
...
### OD-M02 Bắt đầu bảo trì thành công
ID: OD-M02
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Bảo trì
...
### OD-M03 Cuộc gọi/tin nhắn trên app bị vô hiệu hóa trong thời gian bảo trì
ID: OD-M03
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Bảo trì
...
### OD-M04 Kết thúc bảo trì thành công
ID: OD-M04
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Bảo trì
...
### OD-M06 Trạng thái bảo trì không bị hủy khi logout và login lại
ID: OD-M06
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Bảo trì
...
### OD-E01 Xuất CSV danh sách tài khoản SIP
ID: OD-E01
画面/機能カテゴリ: Quản trị viên Okada Denki
...
### OD-E02 Kiểm tra file CSV chỉ chứa người dùng ở trạng thái hợp lệ
ID: OD-E02
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Xuất tài khoản và đồng bộ MVE
...
### OD-E03 Kiểm tra định dạng dữ liệu trong file CSV
ID: OD-E03
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Xuất tài khoản và đồng bộ MVE
...
### OD-E05 Import file CSV vào MVE - người dùng "削除済み" bị xóa khỏi MVE
ID: OD-E05
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Xuất tài khoản và đồng bộ MVE
...
### OD-E06 Chuỗi xử lý bảo trì khi xóa người dùng: xuất file, bảo trì, import MVE, kết thúc
ID: OD-E06
画面/機能カテゴリ: Quản trị viên Okada Denki
大項目: Xuất tài khoản và đồng bộ MVE
...
### SA-OB01 Kiểm tra toàn bộ luồng từ tạo tenant, upload người dùng đến gửi email cho quản trị viên tenant
ID: SA-OB01
...
### SA-OB02 Bỏ qua bước upload người dùng ngay sau khi tạo tenant
ID: SA-OB02
画面/機能カテゴリ: Luồng onboarding
大項目: Onboarding
...
### SA-OB03 Kiểm tra trạng thái người dùng chuyển thành "登録済み" sau khi Okada Denki xác nhận IPGroup
ID: SA-OB03
画面/機能カテゴリ: Luồng onboarding
大項目: Onboarding
...
### SA-OB04 Xác nhận kích hoạt tài khoản người dùng - trạng thái "利用中"
ID: SA-OB04
画面/機能カテゴリ: Luồng onboarding
大項目: Onboarding
...
### SA-OB05 Kiểm tra quản trị viên tenant có thể đăng nhập sau khi nhận email
ID: SA-OB05
画面/機能カテゴリ: Luồng onboarding
大項目: Onboarding
...
| --- | --- | --- | --- | --- | --- | --- |
| 1.0.0 | - | VTI | 2026/06/20 13:33 | 新規作成 | WEB_UAT_TC | UAT元テストケースから104件を正規化 |
